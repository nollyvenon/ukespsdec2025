...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('cv_uploads', function (Blueprint $table) {
            // Add scoring and matching fields
            ...
            if (!Schema::hasColumn('cv_uploads', 'contact_info')) {
                $table->json('contact_info')->nullable()->after('education'); // Store contact info as JSON
            }
            if (!Schema::hasColumn('cv_uploads', 'languages')) {
                $table->json('languages')->nullable()->after('contact_info'); // Languages known
            }
            ...
            // Update text columns to JSON format if needed (this requires doctrine/dbal)
            // For now, focusing on adding new fields
        });
    }
