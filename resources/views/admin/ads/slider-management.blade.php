            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-2xl font-bold">Slider Advertisement Management</h1>
                        <a href="{{ route('admin.ads.create') }}"
                           class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700">
                            <i class="fas fa-plus mr-2"></i>Create Slider Ad
                        </a>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <a href="{{ route('admin.ads.slider') }}" 
                           class="bg-green-600 text-white px-4 py-2 rounded-lg text-center">
                            Slider Ads
                        </a>
                    ...
                    @if($sliderAds->isEmpty())
                        <div class="text-center py-12">
                            <i class="fas fa-images text-5xl text-gray-300 mb-4"></i>
                            <h3 class="text-xl font-medium text-gray-900 mb-2">No slider advertisements found</h3>
                            <p class="text-gray-500 mb-6">Create your first slider advertisement to feature on the home page.</p>
                                    ...
                                    @foreach($sliderAds as $ad)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @if($ad->image_url)
                                                    <img src="{{ asset('storage/' . $ad->image_url) }}" alt="{{ $ad->title }}" class="h-16 object-contain">
                                                @else
