        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-2xl font-bold mb-6">Create New Hero Content</h1>

                    <form method="POST" action="{{ route('admin.hero-contents.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <textarea name="subtitle" id="subtitle" rows="3"
                                          class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('subtitle') border-red-500 @enderror">{{ old('subtitle') }}</textarea>
                                @error('subtitle')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div id="content_url_field" class="hidden">
                            ...
                            <div id="youtube_url_field" class="hidden">
