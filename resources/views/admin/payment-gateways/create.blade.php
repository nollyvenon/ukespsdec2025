                ...
                <div class="card-body">
                    <form action="{{ route('admin.payment-gateways.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="credentials" id="credentials" class="form-control" rows="5" required>{{ old('credentials') ? json_encode(old('credentials')) : '{}' }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="supported_currencies" id="supported_currencies" class="form-control" value="{{ old('supported_currencies') ? implode(',', old('supported_currencies')) : '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="supported_countries" id="supported_countries" class="form-control" value="{{ old('supported_countries') ? implode(',', old('supported_countries')) : '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="transaction_fee_percent" id="transaction_fee_percent" class="form-control" value="{{ old('transaction_fee_percent', 0) }}" step="0.01" min="0" max="100">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="transaction_fee_fixed" id="transaction_fee_fixed" class="form-control" value="{{ old('transaction_fee_fixed', 0) }}" step="0.01" min="0">
