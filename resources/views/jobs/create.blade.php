                    ...
                    <form method="POST" action="{{ route('jobs.store') }}">
                        ...
                        <div class="mb-4">
                            <div class="flex items-center">
                                ...
                                <label for="is_premium" class="ml-2 block text-sm text-gray-900">Make this a premium listing (featured)</label>
                            </div>
                            <p class="mt-1 text-sm text-gray-500">Premium listings appear at the top of search results and get more visibility.</p>
                        </div>
